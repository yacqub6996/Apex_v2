...
/**
 * Checks if a given value is a memoized component (React.memo(...)).
 */
export const isMemoComponent = (component: any): component is React.MemoExoticComponent<any> => {
    return typeof component === "object" && component !== null && component.$$typeof?.toString() === "Symbol(react.memo)";
};
