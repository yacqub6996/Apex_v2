...
const md = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="960" height="960" viewBox="0 0 960 960" fill="none" {...props}>
            <mask id="mask0_4940_405685" className="mask-alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="960" height="960">
...
const sm = (props: SVGProps<SVGSVGElement>) => {
    return (
        <svg width="960" height="960" viewBox="0 0 960 960" fill="none" {...props}>
            <mask id="mask0_4940_405682" className="mask-alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="960" height="960">
