...
const MobilePresetButton = ({ value, children }: HTMLAttributes<HTMLButtonElement> & { value: { start: DateValue; end: DateValue } }) => {
    const context = useContext(RangeCalendarStateContext);
            ...
            >
                <div className="flex flex-col gap-3 px-6 py-5">
                    <header className="relative flex items-center justify-between md:justify-start">
                        ...
                        <Button slot="next" size="small" className="size-8 md:hidden" variant="text" startIcon={<ChevronRight />} />
                    </header>
