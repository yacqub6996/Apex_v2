...
import { MenuBook, ExpandMore, Logout, Add, Settings, Person } from "@mui/icons-material";
        ...
        >
            <div className="rounded-xl bg-primary ring-1 ring-secondary">
                <div className="flex flex-col gap-0.5 py-1.5">
                    <NavAccountCardMenuItem label="View profile" icon={Person} shortcut="⌘K->P" />
                    <NavAccountCardMenuItem label="Account settings" icon={Settings} shortcut="⌘S" />
                    <NavAccountCardMenuItem label="Documentation" icon={MenuBook} />
                </div>
                ...
                <div className="flex flex-col gap-2 px-2 pt-0.5 pb-2">
                    <Button iconLeading={Add} color="secondary" size="sm">
                        Add account
                    </Button>
                </div>
            </div>
            ...
            <div className="absolute top-1.5 right-1.5">
                <AriaDialogTrigger>
                    <AriaButton className="flex cursor-pointer items-center justify-center rounded-md p-1.5 text-fg-quaternary outline-focus-ring transition duration-100 ease-linear hover:bg-primary_hover hover:text-fg-quaternary_hover focus-visible:outline-2 focus-visible:outline-offset-2 pressed:bg-primary_hover pressed:text-fg-quaternary_hover">
                        <ExpandMore className="size-4 shrink-0" />
                    </AriaButton>
                    <AriaPopover
