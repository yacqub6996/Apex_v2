...
import { Notifications, Help, Search, Settings } from "@mui/icons-material";
                ...
                <aside className="flex h-full max-w-full flex-col justify-between overflow-auto border-r border-secondary bg-primary pt-4 lg:pt-6">
                    ...
                    <div className="mt-auto flex flex-col gap-4 px-2 py-4 lg:px-4 lg:py-6">
                        <div className="flex flex-col gap-1">
                            <NavItemBase type="link" href="#" icon={Help}>
                                Support
                            </NavItemBase>
                            <NavItemBase
                                type="link"
                            ...
                            <NavItemBase type="link" href="https://www.untitledui.com/" icon={Settings}>
                                Open in browser
                            </NavItemBase>
                        </div>
