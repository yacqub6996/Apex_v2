...
import { AvatarLabelGroup } from "@/components/application/avatar/avatar-label-group";
...
export const SidebarNavigationSlim = ({ activeUrl, items, footerItems = [], hideBorder, hideRightBorder }: SidebarNavigationSlimProps) => {
    ...
    const mainSidebar = (
        <aside className="group flex h-full max-h-full max-w-full overflow-y-auto bg-primary py-1 pl-1 w-[68px]">
            <div
                className={cx(
    ...
    const secondarySidebar = (
        <AnimatePresence initial={false}>
            {isSecondarySidebarVisible && (
                ...
                >
                    <div className="flex h-full flex-col px-4 pt-6 w-[268px]">
                        ...
                        <div className="sticky bottom-0 mt-auto flex justify-between border-t border-secondary bg-primary px-2 py-5">
                            ...
                            <div className="absolute top-2.5 right-0">
                                <ButtonUtility size="sm" color="tertiary" tooltip="Log out" icon={Logout} />
                            </div>
                        </div>
                    </div>
                </motion.div>
    ...
    return (
        <>
            ...
            <div className="invisible hidden lg:block lg:w-[68px]" />
                ...
                <aside className="group flex h-full max-h-full w-full max-w-full flex-col justify-between overflow-y-auto bg-primary pt-4">
                    ...
                    <div className="mt-auto flex flex-col gap-5 px-2 py-4">
                        <div className="flex flex-col gap-2">
                            <NavItemBase current={activeUrl === "/support"} type="link" href="/support" icon={Help}>
                                Support
                            </NavItemBase>
                            <NavItemBase current={activeUrl === "/settings"} type="link" href="/settings" icon={Settings}>
                                Settings
                            </NavItemBase>
                        </div>
                        ...
                        <div className="relative flex items-center gap-3 border-t border-secondary pt-6 pr-8 pl-2">
                            ...
                            <div className="absolute top-1/2 right-0 -translate-y-1/2">
                                <Button
                                    size="small"
                                    className="size-5 text-fg-quaternary transition-inherit-all group-hover:text-fg-quaternary_hover p-1.5"
                                    variant="text"
